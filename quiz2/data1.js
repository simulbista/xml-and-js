...
//total count of all trips made by all the passengers
console.log("Total trip count made by all passengers is ");
const totalCount = data1.flatMap((record) => record.data).map((item) => 
item.trips).filter((value)=>value).reduce((acc,value) => acc+value);
